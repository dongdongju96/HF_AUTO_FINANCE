...
class DealerTrackAutomation:
    ...
    def fill_and_submit_form(self):
        ...
        self.fill_dropdown("ddLenders", "Windsor Family Credit Union")
        time.sleep(0.5)
    ...
    def select_program(self):
        ...
        program_selection_dropdown = WebDriverWait(self.driver, 10).until(
            EC.element_to_be_clickable((By.ID, "ctl21_ctl20_ctl00_ddlProgram"))
        )
        time.sleep(1)
    ...
    def enter_cash_price(self):
        ...
        cash_price_input = WebDriverWait(self.driver, 10).until(
            EC.element_to_be_clickable((By.ID, "ctl21_ctl21_ctl00_txtCashPrice"))
        )
    ...
    def select_term(self):
        ...
        term_dropdown = WebDriverWait(self.driver, 10).until(
            EC.presence_of_element_located((By.ID, "ctl21_ctl28_ctl00_CTermDropDown1"))
        )
    ...
    def select_amortization(self):
        ...
        amortization_dropdown = self.driver.find_element(By.ID, "ctl21_ctl28_ctl00_CAmortizationPeriodDropDown1")
    ...
    def select_payment_frequency(self):
        ...
        payment_frequency_dropdown = self.driver.find_element(By.ID, "ctl21_ctl28_ctl00_CPaymentFrequencyDropDown1")
    ...
    def select_interest_rate(self):
        ...
        cnt = 0
        while True:
            select_element = wait.until(EC.element_to_be_clickable((By.ID, "ctl21_ctl28_ctl00_CInterestRateDropDown1")))
            ...
            if not options:
                ...
                if program_selection_value == "auto":
                    term_dropdown = self.driver.find_element(By.ID, "ctl21_ctl28_ctl00_CTermDropDown1")
    ...
    def enter_trade_in_field(self, field_id, field_name):
        # ctl21_ctl22_ctl00_txtYear
        input_field = self.driver.find_element(By.ID, f"ctl21_ctl22_ctl00_txt{field_id}")
        input_field.clear()
    ...
    def enter_field(self, field_id, field_name):
        ...
        input_field = self.driver.find_element(By.ID, f"ctl21_ctl25_ctl00_txt{field_id}")
        input_field.clear()
        input_field.send_keys(self.data["fields"].get(field_name, ""))
    ...
    def enter_other_taxable_amounts(self):
        ...
        if other_taxable_amount:
            self.fill_text_field("ctl21_ctl25_ctl00_txtOtherTaxable", str(other_taxable_amount))
            description = "ADMIN/OMVIC/THEFT PROTECTION" if theft_protection == "Yes" else fields.get("Other Taxable Description", "ADMIN/OMVIC")
            self.fill_text_field("ctl21_ctl25_ctl00_txtOtherTaxableDesc", description)
    ...
    def run(self, airtable_client, client_data_id):
        try:
            ...
            # 오늘 안에 모든 은행에 작동이 되게끔 적용 되도록 업무를 지시받아서 try문을 사용함
            try:
