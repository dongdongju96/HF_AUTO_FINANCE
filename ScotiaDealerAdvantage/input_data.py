...
class DealerTrackAutomation:
    ...
    def fill_and_submit_form(self):
        ...
        self.fill_dropdown("ddLenders", "Scotia Dealer Advantage")
        time.sleep(0.5)
    ...
    def select_amortization(self):
        ...
        amortization_dropdown = self.driver.find_element(By.ID, "ctl21_ctl28_ctl00_ddlAmortization")
    ...
    def select_interest_rate(self):
        ...
        while True:
            ...
            if not options:
                ...
                if program_selection_value == "STARTRIGHT":
    ...
    def enter_field(self, field_id, field_name):
        # ctl21_ctl27_ctl00_txtCashDownPayment
        input_field = self.driver.find_element(By.ID, f"ctl21_ctl27_ctl00_txt{field_id}")
        input_field.clear()
        input_field.send_keys(self.data["fields"].get(field_name, ""))
    ...
    def enter_gap_insurance_amount(self):
        ...
        if "Gap Insurance Amount" in self.data["fields"]:
            gap_insurance_input = wait.until(EC.element_to_be_clickable((By.ID, "ctl21_ctl28_ctl00_txtAHInsurance")))
    ...
    def enter_other_taxable_amounts(self):
        ...
        if other_taxable_amount:
            self.fill_text_field("ctl21_ctl27_ctl00_txtOtherTaxable", str(other_taxable_amount))
            description = "ADMIN/OMVIC/THEFT PROTECTION" if theft_protection == "Yes" else fields.get("Other Taxable Description", "ADMIN/OMVIC")
            self.fill_text_field("ctl21_ctl27_ctl00_txtOtherTaxableDesc", description)
