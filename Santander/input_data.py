...
class DealerTrackAutomation:
    ...
    def fill_and_submit_form(self):
        ...
        self.fill_dropdown("ddLenders", "Santander Consumer Inc.")
        time.sleep(0.5)
        # Select "Lease" from ddProduct
        self.fill_dropdown("ddProduct", "Loan")
        time.sleep(0.5)
        # Select "Flow" from ddProduct
        self.fill_dropdown("ddFlowType", "Prime")
        time.sleep(0.5)
    ...
    def select_interest_rate(self):
        ...
        while True:
            ...
            if not options:
                ...
                if program_selection_value == "santander":
    ...
    def enter_other_taxable_amounts(self):
        ...
        if other_taxable_amount:
            ...
            self.fill_text_field("ctl21_ctl26_ctl00_txtOtherTaxableDescription", description)
