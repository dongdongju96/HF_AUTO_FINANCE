...
class DealerTrackAutomation:
    ...
    def fill_and_submit_form(self):
        ...
        self.fill_dropdown("ddLenders", "RIFCO")
        time.sleep(0.5)
    ...
    def select_term(self):
        ...
        term_dropdown = WebDriverWait(self.driver, 10).until(
            EC.presence_of_element_located((By.ID, "ctl21_ctl29_ctl00_ddlTermOfLoan"))
        )
    ...
    def select_amortization(self):
        ...
        amortization_dropdown = self.driver.find_element(By.ID, "ctl21_ctl29_ctl00_ddlAmortizationPeriod")
    ...
    def select_payment_frequency(self):
        ...
        payment_frequency_dropdown = self.driver.find_element(By.ID, "ctl21_ctl29_ctl00_ddlPaymentFrequency")
    ...
    def select_interest_rate(self):
        ...
        cnt = 0
        while True:
            select_element = wait.until(EC.element_to_be_clickable((By.ID, "ctl21_ctl29_ctl00_ddlInterestRate")))
            ...
            if not options:
                ...
                if program_selection_value == "standard fixed":
                    term_dropdown = self.driver.find_element(By.ID, "ctl21_ctl29_ctl00_ddlTermOfLoan")
