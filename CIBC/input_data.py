...
class DealerTrackAutomation:
    ...
    def select_program(self):
        ...
        keywords = ["Programme Special CIBC Vehicle"]
        program_flag = False
    ...
    def select_interest_rate(self):
        ...
        # CIBC 프로그램 선택 관련해서 이자가 선택이 안될 때 문제가 있다면 여기 아래를 처리해야한다.
            ...
            if not options:
                ...
                for option in options:
                    ...
                    for match in matches:
                        ...
                        print(f"No Matching Option Found for '{car_year_selection_value}'")
