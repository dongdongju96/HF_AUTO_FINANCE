...
class DealerTrackAutomation:
    ...
    def fill_and_submit_form(self):
        ...
        self.fill_dropdown("ddLenders", "National Bank of Canada")
    ...
    def select_term(self):
        ...
        term_dropdown = WebDriverWait(self.driver, 10).until(
            EC.presence_of_element_located((By.ID, "ctl21_ctl28_ctl00_ddlTerm"))
        )
    ...
    def select_payment_frequency(self):
        ...
        payment_frequency_dropdown = self.driver.find_element(By.ID, "ctl21_ctl28_ctl00_ddlPaymentFrequency")
        ...
        while True:
            ...
            if not options:
                ...
                if program_selection_value == "standard fixed":
                    term_dropdown = self.driver.find_element(By.ID, "ctl21_ctl28_ctl00_ddlTerm")
